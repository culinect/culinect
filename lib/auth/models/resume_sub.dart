...
class Resume {
  ...
  factory Resume.fromMap(Map<String, dynamic> data) {
    var expList = data['experiences'] as List;
    List<Experience> expTempList =
        expList.map((i) => Experience.fromMap(i)).toList();

    var eduList = data['educations'] as List;
    List<Education> eduTempList =
        eduList.map((i) => Education.fromMap(i)).toList();
