...
class ImageUploaderIo implements PostImageUploader {
  @override
  Future<String> uploadImageToFirebase(String filePath) async {
    if (Platform.isIOS || Platform.isAndroid) {
      ...
      final Reference storageRef = FirebaseStorage.instance.ref('posts/$uid/images/${DateTime.now().millisecondsSinceEpoch}_$fileName.webp');
