...
class RecipeImageUploaderIo implements RecipeImageUploader {
  @override
  Future<String> uploadImageToFirebase(String filePath) async {
    if (Platform.isIOS || Platform.isAndroid) {
      ...
      final Reference storageRef = FirebaseStorage.instance.ref('recipes/$uid/images/${DateTime.now().millisecondsSinceEpoch}_$fileName.webp');
      ...
      throw UnsupportedError('ImageUploaderIo is not supported on this platform.');
    }
  }
}
