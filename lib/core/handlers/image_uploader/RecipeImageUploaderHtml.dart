...
class RecipeImageUploaderHtml implements RecipeImageUploader {
  @override
    ...
    if (kIsWeb) {
      try {
        ...
        if (response.statusCode == 200) {
          ...
          final Reference storageRef = FirebaseStorage.instance.ref('recipes/$uid/images/${DateTime.now().millisecondsSinceEpoch}.webp');
      ...
      throw UnsupportedError('RecipeImageUploaderHtml is not supported on this platform.');
    }
  }
}